...
const Spotlight = () => {
  ...
  const spotlightItems = [
    { name: "Arboreal Villa", img: "/spotlight/spotlight-img-1.jpg?v=2" },
    { name: "Geometric Twilight", img: "/spotlight/spotlight-img-2.jpg?v=2" },
    { name: "Lumina Residence", img: "/spotlight/spotlight-img-3.jpg?v=2" },
    { name: "Ascension Tower", img: "/spotlight/spotlight-img-4.jpg?v=2" },
    { name: "Steel Skeleton", img: "/spotlight/spotlight-img-5.jpg?v=2" },
    { name: "Forest Haven", img: "/spotlight/spotlight-img-6.jpg?v=2" },
    { name: "Atelier Sun", img: "/spotlight/spotlight-img-7.jpg?v=2" },
    { name: "Conceptual White", img: "/spotlight/spotlight-img-8.jpg?v=2" },
    { name: "Textured Form", img: "/spotlight/spotlight-img-9.jpg?v=2" },
    { name: "Brutalist Dawn", img: "/spotlight/spotlight-img-10.jpg?v=2" },
  ];
